...
out[1] = (xd[2]*a[1]);
out[2] = u[0];
out[3] = ((xd[2]*a[2])/(real_t)(1.3200000000000001e+000));
}
...
/* Compute intermediate quantities: */
a[0] = (cos(xd[3]));
a[1] = ((real_t)(-1.0000000000000000e+000)*(sin(xd[3])));
a[2] = (sin(xd[3]));
a[3] = (cos(xd[3]));
a[4] = (tan(u[1]));
a[5] = ((real_t)(1.0000000000000000e+000)/(real_t)(1.3200000000000001e+000));
a[6] = ((real_t)(1.0000000000000000e+000)/(pow((cos(u[1])),2)));
a[7] = ((real_t)(1.0000000000000000e+000)/(real_t)(1.3200000000000001e+000));

/* Compute outputs: */
out[0] = (real_t)(0.0000000000000000e+000);
out[1] = (real_t)(0.0000000000000000e+000);
out[2] = a[0];
out[3] = (xd[2]*a[1]);
out[4] = (real_t)(0.0000000000000000e+000);
out[5] = (real_t)(0.0000000000000000e+000);
out[6] = (real_t)(0.0000000000000000e+000);
out[7] = (real_t)(0.0000000000000000e+000);
out[8] = a[2];
out[9] = (xd[2]*a[3]);
out[10] = (real_t)(0.0000000000000000e+000);
out[11] = (real_t)(0.0000000000000000e+000);
out[12] = (real_t)(0.0000000000000000e+000);
out[13] = (real_t)(0.0000000000000000e+000);
out[14] = (real_t)(0.0000000000000000e+000);
out[15] = (real_t)(0.0000000000000000e+000);
out[16] = (real_t)(1.0000000000000000e+000);
out[17] = (real_t)(0.0000000000000000e+000);
out[18] = (real_t)(0.0000000000000000e+000);
out[19] = (real_t)(0.0000000000000000e+000);
out[20] = (a[4]*a[5]);
out[21] = (real_t)(0.0000000000000000e+000);
out[22] = (real_t)(0.0000000000000000e+000);
out[23] = ((xd[2]*a[6])*a[7]);
}
...
{ 1.0416666666666668e-002, -2.0833333333333333e-003, 
1.8750000000000003e-002, 6.2500000000000003e-003 };
...
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 8) + (j)] -= 1.0000000000000000e+000;
...
if( 1 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 8) + (j + 4)] -= 1.0000000000000000e+000;
}
...
acadoWorkspace.rk_diffsNew2[(i * 6) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)6.2500000000000003e-003;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 4; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 6) + (run1 + 4)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)6.2500000000000003e-003;
}
}
rk_eta[0] += + acadoWorkspace.rk_kkk[0]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_kkk[1]*(real_t)6.2500000000000003e-003;
rk_eta[1] += + acadoWorkspace.rk_kkk[2]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_kkk[3]*(real_t)6.2500000000000003e-003;
rk_eta[2] += + acadoWorkspace.rk_kkk[4]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_kkk[5]*(real_t)6.2500000000000003e-003;
rk_eta[3] += + acadoWorkspace.rk_kkk[6]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_kkk[7]*(real_t)6.2500000000000003e-003;
if( run == 0 ) {
for (i = 0; i < 4; ++i)
{
for (j = 0; j < 4; ++j)
