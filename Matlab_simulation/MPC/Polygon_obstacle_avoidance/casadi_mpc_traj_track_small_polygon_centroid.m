...
SO_polygon(1).point(1).x = {2.0}; SO_polygon(1).point(1).y = {1.0};

SO_polygon(2).point(1).x = {4.0}; SO_polygon(2).point(1).y = {0.0};
SO_polygon(2).point(2).x = {4.0}; SO_polygon(2).point(2).y = {0.5};

SO_polygon(3).point(1).x = {4.0}; SO_polygon(3).point(1).y = {0.5};
SO_polygon(3).point(2).x = {4.0}; SO_polygon(3).point(2).y = {1.0};

SO_polygon(4).point(1).x = {4.0}; SO_polygon(4).point(1).y = {1.0};
SO_polygon(4).point(2).x = {4.0}; SO_polygon(4).point(2).y = {1.5};

SO_polygon(5).point(1).x = {4.0}; SO_polygon(5).point(1).y = {1.5};
SO_polygon(5).point(2).x = {4.0}; SO_polygon(5).point(2).y = {1.8};
SO_polygon(5).point(3).x = {4.3}; SO_polygon(5).point(3).y = {1.8};

SO_polygon(6).point(1).x = {4.3}; SO_polygon(6).point(1).y = {1.8};
SO_polygon(6).point(2).x = {4.8}; SO_polygon(6).point(2).y = {1.8};

SO_polygon(7).point(1).x = {4.3}; SO_polygon(7).point(1).y = {1.8};
SO_polygon(7).point(2).x = {4.8}; SO_polygon(7).point(2).y = {1.8};

SO_polygon(8).point(1).x = {4.8}; SO_polygon(8).point(1).y = {1.8};
SO_polygon(8).point(2).x = {5.3}; SO_polygon(8).point(2).y = {1.8};

SO_polygon(9).point(1).x = {5.3}; SO_polygon(9).point(1).y = {1.8};
SO_polygon(9).point(2).x = {5.8}; SO_polygon(9).point(2).y = {1.8};

SO_polygon(10).point(1).x = {1.0}; SO_polygon(10).point(1).y = {3.0};
SO_polygon(10).point(2).x = {1.5}; SO_polygon(10).point(2).y = {2.5};
SO_polygon(10).point(3).x = {2.0}; SO_polygon(10).point(3).y = {3.0};

SO_polygon(11).point(1).x = {3.0}; SO_polygon(11).point(1).y = {3.5};
SO_polygon(11).point(2).x = {3.5}; SO_polygon(11).point(2).y = {3.0};
SO_polygon(11).point(3).x = {4.1}; SO_polygon(11).point(3).y = {3.3};
SO_polygon(11).point(4).x = {3.8}; SO_polygon(11).point(4).y = {4.0};

[SO_vector, SO_dims] = SO_struct2Matrix(SO_polygon);

n_SO = size(SO_polygon, 2);  %Number of considered polygons nearby
...
P = SX.sym('P',n_states ...                     % Initial states (x0)
               + N*(n_states+n_controls) ...    % Reference trajectory states and control inputs ...    % Goal position
...
x_start = [0, 2, 0.0];
x_goal = [8, 2, 0.0];
u_ref = [0.6, 0];               % Reference control input
