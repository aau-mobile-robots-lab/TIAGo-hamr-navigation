...
void planCB(const nav_msgs::Path::ConstPtr& msg)
{
  ...
  ros::NodeHandle n;
  ros::Publisher callback_pub = n.advertise<geometry_msgs::Twist>("ZZ", 1000);
  callback_pub.publish(testmsg);
...
int main(int argc, char **argv)
{
  ...
  //ros::Publisher plpub = n.advertise<geometry_msgs::Twist>("plpub", 1000);
  
  //ros::Subscriber sub2
  //ros::Subscriber sub = n.subscribe("
  //ros::Subscriber sub = n.subscribe("turtle1/cmd_vel", 1000, planCB);
  ros::spin();
